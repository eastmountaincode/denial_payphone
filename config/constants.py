...
SPEECH_END_PAUSE_SEC = 4.5  # How long to wait after speech ends before transitioning states
MAX_INITIAL_SILENCE_SEC = 13.0  # Max silence before prompting again or disconnecting when recording user long-form speech
AUDIO_SILENCE_THRESHOLD = 0.015  # RMS amplitude below this is considered silence (0.0-1.0)
...
CLASSIFICATION_MARGIN = 0.21     # Minimum margin between highest and second-highest similarity
